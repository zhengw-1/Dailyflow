...
(function testResponsiveSafeguardsPresent() {
  ...
  assert(sw.includes('dailyflow-v22-check-layout'),'service worker cache not bumped');
  assert(html.includes('order-utils.js?v=22'),'HTML cache bust not bumped');
  assert(html.includes('task-inline-edit-utils.js?v=22'),'inline utility cache bust not bumped');
})();
