...
assert(html.includes('order-utils.js?v=23'), 'HTML cache bust must be bumped to v23');
assert(html.includes('task-inline-edit-utils.js?v=23'), 'inline utility cache bust must be bumped to v23');
assert(sw.includes('dailyflow-v23-compact-spacing'), 'service worker cache must be bumped to v23');
console.log('PASS compact spacing v23 tests');
