...
a(html.includes("order-utils.js?v=21"),"HTML utility version not bumped");
a(sw.includes("order-utils.js?v=21"),"SW utility version not bumped");
a(sw.includes('dailyflow-v21-compact-responsive'),"SW cache version not bumped");
