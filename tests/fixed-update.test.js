...
a(html.includes("order-utils.js?v=22"),"HTML utility version not bumped");
a(sw.includes("order-utils.js?v=22"),"SW utility version not bumped");
a(sw.includes('dailyflow-v22-check-layout'),"SW cache version not bumped");
