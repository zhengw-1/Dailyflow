...
a(html.includes("order-utils.js?v=20"),"HTML utility version not bumped");
a(sw.includes("order-utils.js?v=20"),"SW utility version not bumped");
a(sw.includes('dailyflow-v20-check-category-responsive'),"SW cache version not bumped");
